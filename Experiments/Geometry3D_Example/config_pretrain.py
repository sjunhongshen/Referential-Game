...
train_config.pretrain_steps = 40000
train_config.continue_steps = 10000
train_config.pretrain_batch_size = 128
train_config.feature_lr = 1e-3
train_config.belief_lr = 1e-3
...
vision_config = edict()
if game_config.dataset == 'Geometry3D_4':
    ...
    game_config.generated_dataset = None
