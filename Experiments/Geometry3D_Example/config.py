...
train_config = edict()
train_config.device = "/gpu:0"
train_config.batch_size = 128
train_config.feature_lr = 1e-4
train_config.belief_lr = 1e-4
train_config.feature_decay = None
train_config.belief_decay = None
train_config.regularization_param = 1e-3
train_config.iteration_phase1 = 4e4
train_config.iteration_phase2 = 4e4
...
game_config.rational_beta = 10
game_config.dataset = 'Geometry3D_4' #Number_Set, ImageNet, Geometry3D_4

vision_config = edict()
if game_config.dataset == 'Number_Set':
    ...
    game_config.generated_dataset_path = None
...
elif game_config.dataset == 'Geometry3D_4':
...
belief_config.belief_var_1d = -10
