...
class Concept:
	...
	def generate_training_dataset(self, size):
		save_path = '/home/Datasets/Number_Set/Number_Set_%ddis_12attr_5max_Train.npy' % self.num_distractors
	...
	def generate_testing_dataset(self, size):
		training_set = np.load('/home/Datasets/Number_Set/Number_Set_%ddis_12attr_5max_Train.npy' % self.num_distractors).item()
		...
		for k in data:
			data[k] = np.array(data[k])
		np.save('/home/Datasets/Number_Set/Number_Set_%ddis_12attr_5max_Test.npy' % self.num_distractors, data)
		return data
...
def main():
	...
	game_config.generated_dataset_path = '/home/Datasets/Number_Set/Number_Set_%ddis_Train.npy' % game_config.num_distractors
	...
	t1 = time.time()
	for _ in range(10):
		brint(concept_space.rd_generate_concept())
		input()
	print(time.time() - t1)
	exit()
