...
class Concept:
	def __init__(self, game_config):
		...
		if game_config.generated_dataset:
			self.generated_dataset = np.load(game_config.generated_dataset_path, allow_pickle = True).item()
	...
	def generate_training_dataset(self, size, novel_concept = False, random_novel_concept = False):
		if not novel_concept:
			save_path = '/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Train.npy' % self.num_distractors
			...
			if not random_novel_concept:
				...
				continued = True
				while continued:
					separated_idx = np.random.choice(self.data_count, round(0.3 * self.data_count), replace = False)
			...
			if random_novel_concept:
				save_path = '/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Train_Random_Novel_Concept.npy' % self.num_distractors
			else:
	...
	def generate_testing_dataset(self, size, novel_concept = False, random_novel_concept = False):
		if not novel_concept:
			training_set = np.load('/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Train.npy' % self.num_distractors).item()
			# if self.permute:
			...
			for k in data:
				data[k] = np.array(data[k])
			np.save('/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Test.npy' % self.num_distractors, data)
			return data
			# else:
			# 	training_teacher_concept_class = training_set['discrete_concepts']
			# 	training_target_idx = training_set['target_idx']
			...
			if random_novel_concept:
				np.save('/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Test_Random_Novel_Concept.npy' % self.num_distractors, data)
			else:
...
if __name__ == '__main__':
	...
	game_config.dataset_attributes_path = '/home/Datasets/Geometry3D_4/Geometry3D_4_attributes.npy'
	game_config.generated_dataset = True
	game_config.generated_dataset_path = '/home/Datasets/Geometry3D_4/Geometry3D_4_%ddis_Train.npy' % game_config.num_distractors
	game_config.images_path = '/home/Datasets/Geometry3D_4/Geometry3D_4_images.npy'
